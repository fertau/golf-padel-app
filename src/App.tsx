                ...
                <>
                  <ul className="upcoming-list">
                    {visibleUpcoming.map(r => (
                      <li key={r.id}>
                        <div className="upcoming-date upcoming-date-calendar">
                          <span className="upcoming-date-icon" aria-hidden="true">
                        ...
                        <div className="upcoming-content">
                          ...
                          <span className="upcoming-time">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9" /><polyline points="12 7 12 12 15 14" /></svg>
